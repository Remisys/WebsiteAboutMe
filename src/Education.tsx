export const Education = () => <div className="max-w-[1400px] w-[90%] mt-20 backdrop-blur-[72px] bg-white/[.7] flex flex-col border-black  rounded-lg text-center  border-solid border-[2px]">
