export const WorkingExperience = () => <div className=" text-black max-w-[1400px] w-[90%] mt-20 backdrop-blur-[72px] bg-white/[.7] flex flex-col border-black  rounded-lg text-center  border-solid border-[2px]">
  ...
  <ul className='flex flex-col self-start w-full text-start px-7 gap-10 py-10  '>
    <li>
      ...
      <ul className="text-start list-disc ml-5 mt-2 font-serif">
        <li>Continuously implementing diverse JIRA bug, feature, and ops tickets with Scrum Framework as our workflow</li>
        <li>Presented my work in front of stakeholders during Sprint Reviews</li>
        <li>Communicate and deploy JIRA tickets to staging for the QAs to verify their implementation</li>
        <li>Present frontend topics in Community of Practice</li>
        <li>Do code reviews for my colleagues and give guidance to apprentices</li>
        <li>Adjusted the staging deployment pipeline to consider different environment settings</li>
      </ul>
    </li>
    <li>
      <div className="flex flex-col lg:flex-row lg:justify-between pb-4 lg:pb-0">
      ...
      <ul className="text-start list-disc ml-5 mt-2 font-serif">
        <li>Iteratively implemented new features and fixed bugs on their internal and publicly used web applications</li>
        <li>Upgraded the user interface and make them responsive for mobile viewports</li>
        <li>Participated in Daily Meetings</li>
        <li>Conducted Code review for my peers</li>
        <li>Maintained and extend our test files to conduct interact testing which prevents regressions</li>
      </ul>
    </li>
    <li >
      <div className="flex flex-col lg:flex-row lg:justify-between pb-4 lg:pb-0">
