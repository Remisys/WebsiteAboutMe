...
const Button = function(props :myType){
    ...
    <div>
        ...
        <div className="backdrop-blur-[72px] bg-white/[.5] hover:bg-gradient-to-r hover:from-purple-500 hover:to-sky-500 hover:shadow-lg flex-1 border-3  rounded-lg text-center">
